...
export default function BirthdayCard() {
    ...
    return (
        <div className="flex items-center justify-center h-screen w-full bg-gradient-to-br from-purple-400 via-purple-600 to-purple-900 relative overflow-hidden">
            ...
            <div className="aspect-video w-[900px] bg-purple-800/30 backdrop-blur-xl rounded-3xl shadow-2xl flex flex-col items-center justify-center p-12 border border-purple-300 relative overflow-hidden">
                ...
                <h1 className="text-4xl font-extrabold text-purple-100 drop-shadow-2xl mb-8 tracking-wide flex justify-center items-center gap-2" style={{ fontFamily: "var(--font-cursive)" }}>
                    <span role="img" aria-label="party-popper">🎉</span>
                    <span>Happy Birthday My Purple Princess!</span>
                    <span role="img" aria-label="birthday-cake">🎂</span>
                </h1>

                <p className="text-2xl md:text-3xl text-purple-50 text-center font-semibold bg-purple-900/40 p-8 rounded-2xl shadow-lg border border-purple-300 transition-all duration-500">
                    {currentWish}
                </p>
